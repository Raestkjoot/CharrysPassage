...
public class BlitRenderPassFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            Blit(cmd, source, tempRenderTargetHandler.Identifier(), material);
    ...
    public override void Create()
    {
        ...
        // If it does not work for you in Unity 2021 then change RenderPassEvent.AfterRenderingPostProcessing to RenderPassEvent.AfterRendering. 
        // For some reason the material effects are not applied anymore on the AfterRenderingPostProcessing.
